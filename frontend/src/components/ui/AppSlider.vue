<template>
    ...
    :modules="[Autoplay]"
  >
    <swiper-slide v-for="(image, index) in imageUrls" :key="index" @click="openFullscreen(image)">
      <img :src="image" :alt="'Image ' + (index + 1)" />
    </swiper-slide>
  </swiper>
  
    <!-- Fullscreen Modal -->
    <div v-if="fullscreenVisible" class="fullscreen-dialog" @click="closeFullscreen">
